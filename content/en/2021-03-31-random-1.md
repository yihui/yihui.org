...
23. A few years ago I learned that `#daddad` happened to be a valid hex code for
    ...
    ``` html
    <input onkeypress="document.getElementById('circle').style.background=this.value;"/>
    <span id="circle" style="display:inline-block;border-radius:50%;width:1em;height:1em;"></span>
    ```

    <input onkeypress="document.getElementById('circle').style.background=this.value;" value="#daddad" />
