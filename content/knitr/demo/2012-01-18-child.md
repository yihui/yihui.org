...
The chunk option `child` supports the inclusion of child documents. A large Markdown documents can be separated in several child documents that are reunited as necessary in the main document. For example here is how to combine a main document with a child document.We have a child document named `knitr-child.Rmd`:
...
and we have a main document named `main.Rmd` 
...
Compiling `main.Rmd` generates html output for both documents. The content of the child document is placed in the middle of the main document, at the placeholder defined in the main document.
