...
2. Bootstrap。这个我其实已经写得差不多了，但我并不满意，打算重写，参见[这里](https://r.yihui.org/stat/machine_learning/bootstrapping/)。
...
11. 四种基本抽样。参见[这里](https://r.yihui.org/stat/sampling_survey/)。
